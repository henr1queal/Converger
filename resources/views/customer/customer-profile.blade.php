    ...
    <div class="container px-lg-5 mt-lg-3 mb-5">
        ...
        <div class="row mb-4 mb-lg-5 mt-lg-3">
            <div class="col text-center">
                <h3>Visualizando cliente</h3>
            </div>
        </div>
        <div class="card pt-2 py-lg-4 px-2 border-3">
            <div class="card-body">
                <form method="POST" action="{{ route('atualizar_cliente', $customer->id) }}" id="contactForm"
                    class="needs-validation position-relative" novalidate>
                    @method('PUT')
                    @csrf
                    <small class="position-absolute top-0 end-0">Adicionado em {{ $customer->created_at->format('d/m/Y') }},
                        às {{ $customer->created_at->format('H:i') }}.</small>
                    <h5 class="text-center mb-5">Informações gerais</h5>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="nome" id="nome" type="text"
                                    placeholder="Nome" required value="{{ old('nome') ? old('nome') : $customer->name }}" />
                        ...
                        <div class="col-lg-6">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="razaoSocial" id="razaoSocial" type="text"
                                    ...
                                    value="{{ old('razaoSocial') ? old('razaoSocial') : $customer->corporate_reason }}" />
                        ...
                        <div class="col-lg-4">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="cnpj" id="cnpj" type="text"
                                    placeholder="CNPJ" value="{{ old('cnpj') ? old('cnpj') : $customer->cnpj }}" />
                        ...
                        <div class="col-lg-5">
                            <div class="form-floating mb-3">
                                <select class="form-select border-2" name="estruturaLegalDaOrganizacao"
                                    ...
                                    <option
                                        {{ old('estruturaLegalDaOrganizacao') == 1 ? 'selected' : ($customer->organization_type_id == 1 ? 'selected' : '') }}
                                        value="1">Microempreendedor Individual (MEI)</option>
                                    <option
                                        {{ old('estruturaLegalDaOrganizacao') == 2 ? 'selected' : ($customer->organization_type_id == 2 ? 'selected' : '') }}
                                        value="2">Microempresa (ME)</option>
                                    <option
                                        {{ old('estruturaLegalDaOrganizacao') == 3 ? 'selected' : ($customer->organization_type_id == 3 ? 'selected' : '') }}
                                        value="3">Empresa de Pequeno Porte (EPP)</option>
                                    <option
                                        {{ old('estruturaLegalDaOrganizacao') == 4 ? 'selected' : ($customer->organization_type_id == 4 ? 'selected' : '') }}
                                        value="4">Média empresa</option>
                                    <option
                                        {{ old('estruturaLegalDaOrganizacao') == 5 ? 'selected' : ($customer->organization_type_id == 5 ? 'selected' : '') }}
                        ...
                        <div class="col-lg-3">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="inscMunicipal" id="inscMunicipal" type="text"
                                    ...
                                    value="{{ old('inscMunicipal') ? old('inscMunicipal') : $customer->municipal_registration }}" />
                        ...
                        <div class="col-lg-3">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="cep" id="cep" type="text"
                                    ...
                                    value="{{ old('cep') ? old('cep') : $customer->cep }}" />
                        ...
                        <div class="col-lg-5">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="endereco" id="endereco" type="text"
                                    ...
                                    value="{{ old('endereco') ? old('endereco') : $customer->address }}" />
                        ...
                        <div class="col-lg-4">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="bairro" id="bairro" type="text"
                                    ...
                                    value="{{ old('bairro') ? old('bairro') : $customer->neighborhood }}" />
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input mt-3 bg-success" name="temNumero"
                                                ...
                                                {{ $customer->number != null ? 'checked' : null }} />
                                ...
                                <div class="col-lg-8 col-xxl-7 ps-lg-0">
                                    <div class="form-floating mb-3">
                                        <input class="form-control border-2" name="numero" id="numero"
                                            ...
                                            value="{{ old('numero') ? old('numero') : $customer->number }}" />
                        ...
                        <div class="col-lg-3">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="complemento" id="complemento" type="text"
                                    ...
                                    value="{{ old('complemento') ? old('complemento') : $customer->complement }}" />
                        ...
                        <div class="col-lg-4">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="cidade" id="cidade" type="text"
                                    ...
                                    value="{{ old('cidade') ? old('cidade') : $customer->city }}" />
                        ...
                        <div class="col-lg-2">
                            <div class="form-floating mb-3">
                                <select class="form-select border-2" name="estado" id="estado" aria-label="Estado"
                                    required>
                                    <option {{ $customer->state ? '' : 'selected' }} value="" disabled selected>
                                        Selecione</option>
                                    <option
                                        {{ old('estado') == 'AC' ? 'selected' : ($customer->state == 'AC' ? 'selected' : '') }}
                                        value="AC">Acre</option>
                                    <option
                                        {{ old('estado') == 'AL' ? 'selected' : ($customer->state == 'AL' ? 'selected' : '') }}
                                        value="AL">Alagoas
                                    </option>
                                    <option
                                        {{ old('estado') == 'AP' ? 'selected' : ($customer->state == 'AP' ? 'selected' : '') }}
                                        value="AP">Amapá</option>
                                    <option
                                        {{ old('estado') == 'AM' ? 'selected' : ($customer->state == 'AM' ? 'selected' : '') }}
                                        value="AM">Amazonas
                                    </option>
                                    <option
                                        {{ old('estado') == 'BA' ? 'selected' : ($customer->state == 'BA' ? 'selected' : '') }}
                                        value="BA">Bahia</option>
                                    <option
                                        {{ old('estado') == 'CE' ? 'selected' : ($customer->state == 'CE' ? 'selected' : '') }}
                                        value="CE">Ceará</option>
                                    <option
                                        {{ old('estado') == 'DF' ? 'selected' : ($customer->state == 'DF' ? 'selected' : '') }}
                                        value="DF">Distrito
                                        Federal</option>
                                    <option
                                        {{ old('estado') == 'ES' ? 'selected' : ($customer->state == 'ES' ? 'selected' : '') }}
                                        value="ES">Espírito Santo
                                    </option>
                                    <option
                                        {{ old('estado') == 'GO' ? 'selected' : ($customer->state == 'GO' ? 'selected' : '') }}
                                        value="GO">Goiás</option>
                                    <option
                                        {{ old('estado') == 'MA' ? 'selected' : ($customer->state == 'MA' ? 'selected' : '') }}
                                        value="MA">Maranhão
                                    </option>
                                    <option
                                        {{ old('estado') == 'MT' ? 'selected' : ($customer->state == 'MT' ? 'selected' : '') }}
                                        value="MT">Mato Grosso
                                    </option>
                                    <option
                                        {{ old('estado') == 'MS' ? 'selected' : ($customer->state == 'MS' ? 'selected' : '') }}
                                        value="MS">Mato Grosso do
                                        Sul</option>
                                    <option
                                        {{ old('estado') == 'MG' ? 'selected' : ($customer->state == 'MG' ? 'selected' : '') }}
                                        value="MG">Minas Gerais
                                    </option>
                                    <option
                                        {{ old('estado') == 'PA' ? 'selected' : ($customer->state == 'PA' ? 'selected' : '') }}
                                        value="PA">Pará</option>
                                    <option
                                        {{ old('estado') == 'PB' ? 'selected' : ($customer->state == 'PB' ? 'selected' : '') }}
                                        value="PB">Paraíba
                                    </option>
                                    <option
                                        {{ old('estado') == 'PR' ? 'selected' : ($customer->state == 'PR' ? 'selected' : '') }}
                                        value="PR">Paraná
                                    </option>
                                    <option
                                        {{ old('estado') == 'PE' ? 'selected' : ($customer->state == 'PE' ? 'selected' : '') }}
                                        value="PE">Pernambuco
                                    </option>
                                    <option
                                        {{ old('estado') == 'PI' ? 'selected' : ($customer->state == 'PI' ? 'selected' : '') }}
                                        value="PI">Piauí</option>
                                    <option
                                        {{ old('estado') == 'RJ' ? 'selected' : ($customer->state == 'RJ' ? 'selected' : '') }}
                                        value="RJ">Rio de Janeiro
                                    </option>
                                    <option
                                        {{ old('estado') == 'RN' ? 'selected' : ($customer->state == 'RN' ? 'selected' : '') }}
                                        value="RN">Rio Grande do
                                        Norte</option>
                                    <option
                                        {{ old('estado') == 'RS' ? 'selected' : ($customer->state == 'RS' ? 'selected' : '') }}
                                        value="RS">Rio Grande do
                                        Sul</option>
                                    <option
                                        {{ old('estado') == 'RO' ? 'selected' : ($customer->state == 'RO' ? 'selected' : '') }}
                                        value="RO">Rondônia
                                    </option>
                                    <option
                                        {{ old('estado') == 'RR' ? 'selected' : ($customer->state == 'RR' ? 'selected' : '') }}
                                        value="RR">Roraima
                                    </option>
                                    <option
                                        {{ old('estado') == 'SC' ? 'selected' : ($customer->state == 'SC' ? 'selected' : '') }}
                                        value="SC">Santa Catarina
                                    </option>
                                    <option
                                        {{ old('estado') == 'SP' ? 'selected' : ($customer->state == 'SP' ? 'selected' : '') }}
                                        value="SP">São Paulo
                                    </option>
                                    <option
                                        {{ old('estado') == 'SE' ? 'selected' : ($customer->state == 'SE' ? 'selected' : '') }}
                                        value="SE">Sergipe
                                    </option>
                                    <option
                                        {{ old('estado') == 'TO' ? 'selected' : ($customer->state == 'TO' ? 'selected' : '') }}
                                        value="TO">Tocantins
                                    </option>
                                </select>
                        ...
                        <div class="col-lg-4">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="emailPrincipal" id="emailPrincipal"
                                    ...
                                    value="{{ old('emailPrincipal') ? old('emailPrincipal') : $customer->emailPrincipal }}" />
                        ...
                        <div class="col-lg-4">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="telefonePrincipal" id="telefonePrincipal"
                                    ...
                                    value="{{ old('telefonePrincipal') ? old('telefonePrincipal') : $customer->phone }}" />
                        ...
                        <div class="col-lg-4">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="celularPrincipal" id="celularPrincipal"
                                    ...
                                    value="{{ old('celularPrincipal') ? old('celularPrincipal') : $customer->phone_number }}" />
                        ...
                        <div class="col-lg-4">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="responsavelPeloPagamento"
                                    ...
                                    value="{{ old('responsavelPeloPagamento') ? old('responsavelPeloPagamento') : ($customer->responsible ? $customer->responsible->full_name : '') }}" />
                        ...
                        <div class="col-lg-4">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="telefoneDoResponsavel"
                                    ...
                                    required
                                    value="{{ old('telefoneDoResponsavel') ? old('telefoneDoResponsavel') : ($customer->responsible ? $customer->responsible->phone : '') }}" />
                        ...
                        <div class="col-lg-4">
                            <div class="form-floating mb-3">
                                <select class="form-select border-2" name="origemDoCliente" id="origemDoCliente"
                                    aria-label="Origem do cliente" required>
                                    <option value="0"
                                        {{ old('origemDoCliente') == 0 ? 'selected' : ($customer->origin === 0 ? 'selected' : '') }}>
                                        Manual</option>
                                    <option value="1"
                                        {{ old('origemDoCliente') == 1 ? 'selected' : ($customer->origin === 1 ? 'selected' : '') }}>
                                        Outro</option>
                                </select>
                        ...
                        <div class="col">
                            <div class="form-floating mb-3">
                                <textarea class="form-control border-2" name="observacao" id="observacao" type="text" placeholder="Observação"
                                    style="height: 10rem;">{{ old('observacao') ? old('observacao') : $customer->observation }}</textarea>
                        ...
                        <div class="col-lg-3">
                            <div class="form-floating mb-3">
                                <select class="form-select border-2" name="banco" id="banco" aria-label="Banco"
                                    required>
                                    <option {{ $customer->bank_id ? '' : 'selected' }} value="" disabled>
                                        Selecione um banco</option>
                                    @foreach ($banks as $bank)
                                        <option
                                            {{ old('banco') == $bank->id ? 'selected' : ($customer->bank_id == $bank->id ? 'selected' : '') }}
                        ...
                        <div class="col-lg-2">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="agencia" id="agencia" type="text"
                                    ...
                                    value="{{ old('agencia') ? old('agencia') : $customer->agency }}" />
                        ...
                        <div class="col-lg-3">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="conta" id="conta" type="text"
                                    ...
                                    value="{{ old('conta') ? old('conta') : $customer->account }}" />
                        ...
                        <div class="col-lg-4">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="chavePix" id="chavePix" type="text"
                                    ...
                                    value="{{ old('chavePix') ? old('chavePix') : $customer->pix }}" />
                        ...
                        <div class="col-lg-3">
                            <div class="form-floating mb-3">
                                <select class="form-select border-2" name="condicoesDePagamento"
                                    id="condicoesDePagamento" aria-label="Condições de pagamento" required>
                                    <option {{ $customer->financial_observation ? '' : 'selected' }} value=""
                                        disabled selected>Padrão</option>
                                    <option
                                        {{ old('condicoesDePagamento') == 1 ? 'selected' : ($customer->financial_observation == 1 ? 'selected' : '') }}
                                        value="1">
                                        7 dias
                                    </option>
                                    <option
                                        {{ old('condicoesDePagamento') == 2 ? 'selected' : ($customer->financial_observation == 2 ? 'selected' : '') }}
                                        value="2">
                                        14 dias
                                    </option>
                                    <option
                                        {{ old('condicoesDePagamento') == 3 ? 'selected' : ($customer->financial_observation == 3 ? 'selected' : '') }}
                                        value="3">
                                        30 dias
                                    </option>
                                    <option
                                        {{ old('condicoesDePagamento') == 4 ? 'selected' : ($customer->financial_observation == 4 ? 'selected' : '') }}
                                        value="4">
                                        45 dias
                                    </option>
                                    <option
                                        {{ old('condicoesDePagamento') == 5 ? 'selected' : ($customer->financial_observation == 5 ? 'selected' : '') }}
                                        value="5">
                                        60 dias
                                    </option>
                                    <option
                                        {{ old('condicoesDePagamento') == 6 ? 'selected' : ($customer->financial_observation == 6 ? 'selected' : '') }}
                                        value="6">
                                        90 dias
                                    </option>
                                    <option
                                        {{ old('condicoesDePagamento') == 7 ? 'selected' : ($customer->financial_observation == 7 ? 'selected' : '') }}
                                        value="7">
                                        120 dias
                                    </option>
                                </select>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ route('deletar_cliente', $customer->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
        ...
        <div class="row">
            <div class="col-6 mt-5">
                <a href="{{ route('meus_clientes') }}" class="btn btn-info text-decoration-none me-5">Ver todos os
                    clientes</a>
            </div>
