    ...
    <div class="container px-lg-5 mt-lg-3 mb-5">
        ...
        <div class="row mb-3 mb-lg-5">
            <div class="col text-center">
                <h3><strong>Nossos palestrantes</strong></h3>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <table id="table" class="table table-striped py-lg-4" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($partners as $partner)
                                        <tr data-href="{{ route('visualizar_parceiro', $partner->id) }}"
                                            style="cursor: pointer">
                                            <td>{{ $partner->name }}</td>
                                            <td>{{ $partner->responsible->full_name }}</td>
                                            <td>{{ $partner->email }}</td>
                                            <td>{{ $partner->responsible->phone }}</td>
                                            <td>{{ $partner->city }}</td>
                                            <td>1</td>
                                        </tr>
                                    @endforeach
                        ...
                        @else
                            ...
                            <p>Adicione o primeiro parceiro <a href="{{ route('novo_parceiro') }}">clicando aqui.</a></p>
                        @endif
                    </div>
                </div>
            </div>
