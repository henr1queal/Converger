    ...
    <div class="container px-lg-5 mt-lg-3 mb-5">
        ...
        <div class="row mb-3 mb-lg-5">
            <div class="col text-center">
                <h3><strong>Novo palestrante</strong></h3>
            </div>
        </div>
        <div class="card pt-2 py-lg-4 px-2 border-3">
            <div class="card-body">
                <form method="POST" action="{{ route('adicionar_palestrante') }}" id="contactForm" class="needs-validation"
                    novalidate>
                    @csrf
                    ...
                    <div class="d-none" id="submitSuccessMessage">
                        <div class="text-center mb-3">
                            <div class="fw-bolder">Novo palestrante adicionado com sucesso!</div>
                        </div>
                    </div>
                    <div class="d-grid">
