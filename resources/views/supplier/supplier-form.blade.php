    ...
    <div class="container px-lg-5 mt-lg-3 mb-5">
        ...
        <div class="row mb-3 mb-lg-5">
            <div class="col text-center">
                <h3><strong>Novo fornecedor</strong></h3>
            </div>
        </div>
        <div class="card pt-2 py-lg-4 px-2 border-3">
            <div class="card-body">
                <form method="POST" action="{{ route('adicionar_fornecedor') }}" id="contactForm" class="needs-validation"
                    novalidate>
                    @csrf
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-select border-2" name="categoria" id="categoria" aria-label="Categoria"
                                    ...
                                    <option value="" disabled {{ old('categoria') ? '' : 'selected' }}>
                                        Selecione um categoria</option>
                                    @foreach ($categories as $category)
                                        <option {{ old('categoria') === $category->id ? 'selected' : '' }}
                                ...
                                <div class="col-lg-6">
                                    <div class="form-floating mb-3">
                                        <input class="form-control border-2" name="numero" id="numero"
                                            type="number" placeholder="Número" value="{{ old('numero') }}" required />
                        ...
                        <div class="col-lg-4">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="telefoneDoResponsavel"
                                    ...
                                    required value="{{ old('telefoneDoResponsavel') }}" />
                        ...
                        <div class="col-lg-2">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="agencia" id="agencia" type="text"
                                    placeholder="Agência" required value="{{ old('agencia') }}" />
                        ...
                        <div class="col-lg-3">
                            <div class="form-floating mb-3">
                                <input class="form-control border-2" name="conta" id="conta" type="text"
                                    placeholder="Conta" required value="{{ old('conta') }}" />
                    ...
                    <div class="d-none" id="submitSuccessMessage">
                        <div class="text-center mb-3">
                            <div class="fw-bolder">Novo fornecedor adicionado com sucesso!</div>
                        </div>
                    </div>
                    <div class="d-grid">
